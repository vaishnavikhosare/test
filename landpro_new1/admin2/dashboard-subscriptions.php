  ...
  <?php  } ?>
      			<h3> Subscription Submissions</h3>
    <a href="dashbord.php?contactform=<?php echo $cu_id; ?>" class="edit-btn" > Contact Form  </a> 		

     <a href="dashbord.php?inquiries=<?php echo $cu_id; ?>" class="edit-btn" > Arrange Viewing  </a> 		
...
$cu_id=$_SESSION['a_id'];
$t=0;
$qpx="SELECT * FROM property_alert ORDER BY pa_id DESC";
...
?>      <tr>                              
  <td>   <?php echo $t; ?></td>
     ...
     <td>  <a href="mailto:<?php echo $rowpx['pa_email']; ?>" style="font-weight: 800;"> <?php echo $rowpx['pa_email']; ?></a></td>
  <td>   <?php echo convertdate($rowpx['pa_date']); ?></td>     
