...
$cu_id=$_SESSION['a_id'];
$t=0;
$qpx="SELECT * FROM users ORDER BY registrationDate DESC";
...
?>      <tr>                              
  <td>   <?php echo $t; ?></td>
 <td>  
 <a href="dashbord.php?user-details=<?php echo $rowpx['userID']; ?>" style="font-weight: 800;color: #00a3be;">  <?php echo $rowpx['username']; ?></a>
</td>
